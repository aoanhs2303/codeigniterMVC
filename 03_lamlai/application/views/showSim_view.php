		...
		<?php foreach ($mangdl as $key => $value) { ?>
			<div class="col-sm-4">
				<div class="card card-block">
					...
					<a href="delete/<?php echo $value['id'] ?>" class="btn btn-danger"><i class="fa fa-times"></i></a>
					
					<a href="edit/<?php echo $value['id']; ?>" class="btn btn-success"><i class="fa fa-pencil"></i></a>
				</div>
			</div>
		<?php	} ?>
		</div>
