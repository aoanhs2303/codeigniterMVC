...
<body>
    ...
    <div class="container">
        ...
        <div class="row mt-3">
            ...
            <form class="m-auto" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/nhanvien/update">
                <?php foreach ($mangDL as $key => $value) { ?>
                <div class="row mb-3">
                  <div class="col-4 push-sm-4">
                    <img src="<?php echo $value['avatar'] ?>" alt="" class="img-fluid">
                  </div>
                </div>
                <input type="hidden" id="id" name="id" value="<?php echo $value['id'] ?>">
                <input type="hidden" id="anhavatar2" name="avatar2" value="<?php echo $value['avatar'] ?>">
                <div class="form-group row">

                  <label for="anhavatar" class="col-3 col-form-label text-xs-right">Ảnh đại diện</label>
                  <div class="col-9">
                    
                    <input class="form-control" type="file" name="avatar" id="anhavatar">
                  </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                         <div class="form-group row">
                          ...
                          <div class="col-9">
                            <input class="form-control" type="text" name="luong" id="sdt" value="<?php echo $value['luong'] ?>">
                          </div>
                        </div>   
                    </div>
                </div>
