...
<link rel="shortcut icon" href="<?php echo base_url(); ?><?php echo base_url(); ?>images/favicon.ico" type="image/x-icon">
<link rel="icon" href="<?php echo base_url(); ?><?php echo base_url(); ?>images/favicon.ico" type="image/x-icon">
<!-- Responsive -->
            	...
            	<div class="clearfix">
                    ...
                    <div class="top-left">
                        ...
                        <div class="social-icon">
                        	<a href="<?php echo $mangXH['linkFB']; ?>"><span class="fa fa-facebook"></span></a>
                            <a href="<?php echo $mangXH['linkTW']; ?>"><span class="fa fa-twitter"></span></a>
                            <a href="<?php echo $mangXH['linkP']; ?>"><span class="fa fa fa-skyatlas"></span></a>
                            <a href="<?php echo $mangXH['linkGP']; ?>"><span class="fa fa fa-tumblr"></span></a>
                            
                        </div>
                        
                    	<ul class="clearfix">
                        	<li><?php echo $hotline['textHotLine']; ?>: <?php echo $hotline['sdt']; ?></li>
                        </ul>
                    </div>
                    ...
                    <div class="top-right">
                    	...
                    	<ul>
                        	<li><?php echo $giomocua['text']; ?> : <?php echo $giomocua['gio']; ?></li>
            ...
            <div class="row clearfix">
                ...
                <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <section class="blog-news-section classic-view">
                        ...
                        <?php foreach ($dulieutin as $mottin) { ?>
                        <!--News Block-->
                        <div class="news-block">
                            <div class="inner-box">
                                <figure class="image-box">
                                    <a href="<?php echo base_url(); ?>index.php/tintuc/detail/<?php echo $mottin['id']; ?>"><img src="<?php echo $mottin['anhtin']; ?>" alt="" /></a>
                                </figure>
                                <div class="lower-content">
                                	<!--Post Header-->
                                	<div class="post-header">
                                    	<h3><a href="<?php echo base_url(); ?>index.php/tintuc/detail/<?php echo $mottin['id']; ?>"><?php echo $mottin['tieude'] ?></a></h3>
                                    	<div class="meta"><?php echo date('d/m/Y',$mottin['ngaytao']); ?>  by <span>Trần Như Lực</span> :: category: <span><?php echo $mottin['tendanhmuc']; ?></span></div>
                                    </div>
                                    <div class="text"><?php echo $mottin['trichdan'] ?></div>
                                    <div class="lower-box clearfix">
                                        <div class="read-more pull-left"><a href="<?php echo base_url(); ?>index.php/tintuc/detail/<?php echo $mottin['id']; ?>">Read More</a></div>
                        ...
                        <!--Pagination-->
                        <?php // LẤY VỀ SỐ TRANG Ở TRÊN URL
                        ...
                        <div class="styled-pagination text-center">
                            <ul>
                                <?php for ($i=0; $i < $sotrang ; $i++) { 
                                    if ($i + 1 == $uri) {?>
                                        <li><a class="active" href="<?php echo base_url(); ?>index.php/tintuc/page/<?php echo $i + 1 ?>"><?php echo $i + 1 ?></a></li>
                                    <?php }else{ ?>
                                        <li><a href="<?php echo base_url(); ?>index.php/tintuc/page/<?php echo $i + 1 ?>"><?php echo $i + 1 ?></a></li>
                                <?php }} ?>

                                <?php if ($uri < $i) { is_numeric($uri) ? null : $uri = 1;  ?>
                                    <li><a class="next" href="<?php echo base_url(); ?>index.php/tintuc/page/<?= $uri + 1 ?>">Next</a></li>

                                <?php } else { ?>
                                    <li><a class="btn next disabled" href="<?php echo base_url(); ?>index.php/tintuc/page/<?= $uri + 1 ?>">Next</a></li>
