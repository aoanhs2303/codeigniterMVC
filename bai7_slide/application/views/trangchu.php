						...
						<?php foreach ($mangdl as $key => $value) { ?>
							<li>
								<div class="w3l_banner_nav_right_banner">
									...
									<div class="more">
										<a href="<?php echo $value['button_link'] ?>" class="button--saqui button--round-l button--text-thick" data-text="Shop now"><?php echo $value['button_text'] ?></a>
									</div>
									<!-- <img src="<?php echo $value['slide_image']; ?>" alt="">
								...
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="<?php echo base_url(); ?>images/1.png" /></a>		
						...
						<div class="agile_top_brand_left_grid">
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="<?php echo base_url(); ?>images/3.png" /></a>		
						...
						<div class="agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="<?php echo base_url(); ?>images/4.png" alt=" " class="img-responsive" /></a>
											<p>dogs food (4 Kg)</p>
